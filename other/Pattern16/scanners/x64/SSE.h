#ifndef PATTERN16_SCANNERS_X64_SSE_H
#define PATTERN16_SCANNERS_X64_SSE_H
...
namespace Pattern16 {
	namespace Impl {
		...
		PATTERN16_NO_INLINE static const void* scanRegion(const void* regionStart, const void* regionEnd, size_t sigStart, int, SplitSignature<__m128i>& signature, size_t length) {
...
#endif // PATTERN16_SCANNERS_X64_SSE_H