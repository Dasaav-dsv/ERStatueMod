#ifndef UNIHOOK_DECODER_H
#define UNIHOOK_DECODER_H
		...
		Decoder() {
			if (!Decoder::decoder) {
				...
				if (ZYAN_FAILED(status)) {
					Logger::log(Logger::ERR, "Failed to initialize Zydis instruction decoder; error %X", status);
